...
mod service_impl {
    ...
    use super::{
        CfsctlService, FsckReply, GcReply, ImageObjectsReply, OpenRepo, OpenRepositoryReply,
        RepositoryError, run_fsck, run_gc, run_image_objects,
    };
...
mod service_impl {
    ...
    use super::{
        CfsctlService, FsckReply, GcReply, ImageObjectsReply, OpenRepo, OpenRepositoryReply,
        RepositoryError, run_compute_id, run_fsck, run_gc, run_image_objects, run_inspect,
        run_list_images, run_oci_fsck, run_tag, run_untag,
    };
    use composefs::fsverity::{Sha256HashValue, Sha512HashValue};
...
pub mod proxy {
    ...
    use super::{FsckReply, GcReply, ImageObjectsReply, OpenRepositoryReply, RepositoryError};
    #[cfg(feature = "oci")]
    use zlink::futures_util::Stream;
