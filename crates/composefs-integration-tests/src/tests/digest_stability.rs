...
const CENTOS_BOOTC: ContainerImage = ContainerImage {
    ...
    expected_v1_bootable_id: Some(
        "6887b843735d9e50ee988058537e42cd157e78f76e53a2a9919180caaab6556\
         8d13e09a1efcfc8865aab2ffd91bbd821d7d56db46e3713d514228a7283ccb91c",
    ),
};
...
const UBUNTU_RESOLUTE: ContainerImage = ContainerImage {
    ...
    expected_id: "74339e9258832768cce45dee66373996399c10ee1b3498be43d8e95af7fde1ad\
                  0b3373128adc8b5a457c4aa577235962cabbcd4c75735b36e8a75356ef5bd745",
    expected_bootable_id: None,
